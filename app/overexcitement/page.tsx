...
export const metadata: Metadata = {
  title: '狗狗過度興奮怎麼辦？衝動控制與冷靜訓練對策',
  description: '改善狗狗過度興奮與衝動行為，學習衝動控制遊戲與冷靜訓練技巧，建立更好的互動模式。',
}

const behavior = behaviors.find(b => b.id === 'overexcitement')!
const strategies = getStrategies('overexcitement')
