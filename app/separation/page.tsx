...
export const metadata: Metadata = {
  title: '狗狗分離焦慮怎麼辦？完整分析與漸進式訓練對策',
  description: '狗狗分離焦慮的專業分析與漸進式獨處訓練，幫助狗狗建立獨處安全感，改善焦慮行為。',
}

const behavior = behaviors.find(b => b.id === 'separation')!
const strategies = getStrategies('separation')
